...
void vkw::VulkanDevice::EnableDeviceExtension(const char* extension)
{
	m_DeviceExtensions.push_back(extension);
}

void vkw::VulkanDevice::EnableInstanceExtension(const char* extension)
{
...
void VulkanDevice::SetupDebug()
{
	...
	m_InstanceLayers.push_back("VK_LAYER_LUNARG_assistant_layer");
	//m_InstanceLayers.push_back("VK_LAYER")
