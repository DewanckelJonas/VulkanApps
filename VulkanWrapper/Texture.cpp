...
void vkw::Texture::CopyTo(Texture * texture, CommandPool* pCommandPool, uint32_t sourceLayer, uint32_t destLayer)
{
	...
	VkCommandBuffer cmdBuffer = pCommandPool->BeginSingleTimeCommands();
	...
	pCommandPool->EndSingleTimeCommands(cmdBuffer);
}
